...
function node(id, overrides = {}) {
    return {
        data: {
            ...
            functionalDomainPrimary: "Emergency Management",
...
function fullFilterState(overrides = {}) {
    return {
        ...
        allowedFunctionalDomains: new Set(["Emergency Management", "Community Resilience"]),
...
const nodes = [
    ...
    node("b", {
        ...
        functionalDomains: ["Community Resilience"],
        functionalDomainPrimary: "Community Resilience",
