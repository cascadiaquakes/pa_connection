...
export const viewerConfig = {
    ...
    dimensions: [
        ...
        {
            key: "lifeline", title: "FEMA Lifeline", dataKey: "femaLifelinePrimary", arrayKey: "lifelineTags",
            filterContainerId: "lifelineFilters", selectionContainerId: "selectionLifelineFilters",
            filterStateKey: "allowedLifelines", selectionStateKey: "selectedLifelines",
            filterLogKey: "lifelines", selectionLogKey: "selectionLifelines",
            filterStatus: { label: "FEMA lifelines", singular: "lifeline" },
            search: { key: "lifelineTags", label: "FEMA lifeline", order: 80 },
            order: ["Communications", "Energy", "Food Hydration Shelter", "Health Medical", "Safety Security", "Transportation", "Water Systems", "Other"],
            colors: { "Communications": "#F28E2B", "Energy": "#E15759", "Food Hydration Shelter": "#EDC948", "Health Medical": "#B07AA1", "Safety Security": "#4E79A7", "Transportation": "#59A14F", "Water Systems": "#76B7B2", "Other": "#9E9E9E" },
            fallbackColor: "#9E9E9E",
        },
        {
    ...
    details: {
        node: {
            ...
            fields: [
                ...
                { label: "FEMA lifelines", dimensionKey: "lifeline" },
